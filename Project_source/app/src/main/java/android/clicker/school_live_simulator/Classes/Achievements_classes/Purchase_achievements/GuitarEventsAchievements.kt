...
enum class GuitarEventsAchievements(val achievement_name: String, val achievement_message: String): PurchaseAchievements {
    ...
    DUAL_NECK_GUITAR(achievement_name = Game.context_bundle.getTitle("ach_dual_neck_guitar_name"), achievement_message = Game.context_bundle.getTitle("ach_dual_neck_guitar_text"))
}
