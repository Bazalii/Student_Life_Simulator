...
enum class EntertainmentEventsRandomAchievements(val achievement_name: String, val achievement_message: String, override val achievement_chance: Int): RandomAchievements {
    ...
    BOTTLE_FLIP(achievement_name = Game.context_bundle.getTitle("ach_bottle_flip_name"), achievement_message = Game.context_bundle.getTitle("ach_bottle_flip_text"), achievement_chance = Game.context_bundle.getNumber("ach_bottle_flip_chance")),
