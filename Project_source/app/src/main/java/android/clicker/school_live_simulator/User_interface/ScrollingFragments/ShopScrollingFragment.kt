...
import android.clicker.school_live_simulator.Classes.AchievementsClasses.PurchaseAchievements.BicycleEventsAchievements
import android.clicker.school_live_simulator.Classes.AchievementsClasses.PurchaseAchievements.ComputerEventsAchievements
import android.clicker.school_live_simulator.Classes.AchievementsClasses.PurchaseAchievements.GuitarEventsAchievements
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.shopGuitarCourseV1.setOnClickListener {
            try {
                ...
                updateUI()
                Game.game_date.end_signal_handlers["guitar_course"] = Game.player.current_courses.guitar_course::timerEndHandler
                Timer(Game.player.current_courses.guitar_course.course_length).registerTimeHandler("guitar_course")
        ...
        binding.shopComputerCourseV1.setOnClickListener {
            try {
                ...
                updateUI()
                Game.game_date.end_signal_handlers["computer_course"] = Game.player.current_courses.computer_course::timerEndHandler
                Timer(Game.player.current_courses.computer_course.course_length).registerTimeHandler("computer_course")
            } catch(exception: NotEnoughMoneyException){
